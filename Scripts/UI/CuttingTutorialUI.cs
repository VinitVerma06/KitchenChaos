...
public class CuttingTutorialUI : MonoBehaviour {
    ...
    private void Start() {
        ...
        TutorialUI.OnCuttingTutorialRequested += TutorialUI_OnCuttingTutorialRequested;
        TutorialUI.OnPlayerCut += TutorialUI_OnPlayerCut;
    }

    private void TutorialUI_OnCuttingTutorialRequested() {
        Show();
        animator.SetTrigger(SHOW_TRIGGER);
    }

    private void TutorialUI_OnPlayerCut() {
